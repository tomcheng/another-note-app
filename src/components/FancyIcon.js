  ...
  switch (icon) {
    case "checked":
      path = (
        <g>
          <path
            fill="#222"
            d="M19,19H5V5H15V3H5C3.89,3 3,3.89 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0
    ...
    case "close":
      path = (
        <polygon
          fill={color}
          points="20.707,4.707 19.293,3.293 12,10.586 4.707,3.293 3.293,
    ...
    case "list":
      path = (
        <g>
          <polygon
            fill={color}
            points="21.5,14 23,15.5 16,22.5 11.5,18 13,16.5 16,19.5 "
          />
          <path
            fill={color}
            d="M10,19H5V5h2v1c0,0.6,0.4,1,1,1s1-0.4,1-1V5h2v1c0,0.6,0.4,1,1,1s1-0.4,1-1V5h2v1c0,0.6,0.4,1,1,1s1-0.4,1-1V5
    ...
    case "pin":
      path = (
        <path
          fill={color}
          d="M22,12l-9.9-9.9l-1.4,1.4l1.4,1.4v0l-5,4.9v0L5.7,8.5L4.3,9.9l4.2,4.2l-5.7,5.7l1.4,1.4l5.7-5.7l4.2,4.2
