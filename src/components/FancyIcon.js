...
const FancyIcon = ({ icon, color }) => {
  ...
  switch (icon) {
    ...
    case "list":
      path = (
        <g>
          <polygon fill={color} points="11,8.586 9.707,7.293 8.293,8.707 11,11.415 15.707,6.707 14.293,5.293" />
          <polygon fill={color} points="11,15.586 9.707,14.293 8.293,15.707 11,18.415 15.707,13.707 14.293,12.293" />
          <path fill={color} d="M18,2H6C4.897,2,4,2.897,4,4v16c0,1.103,0.897,2,2,2h12c1.103,0,2-0.897,
    ...
    case "note":
      path = (
        <g>
          <path fill={color} d="M15.414,2H6C4.897,2,4,2.898,4,4v16c0,1.103,0.897,2,2,2h12c1.103,0,
          2-0.897,2-2V6.586L15.414,2z M18.001,20H6V4h8v4h4L18.001,20z" />
          <rect x="8" y="11" fill={color} width="6" height="2" />
          <rect x="8" y="15" fill={color} width="8" height="2" />
        </g>
      );
      break;
    case "pencil":
